    ...
    public void TransferItemToInventory(ItemSlot sourceSlot, ItemSlot targetSlot, ClickType clickType)
    {
        ...
        if (sourceSlot.item != null)
        {
            ...
            if (targetSlot.item == null)
            {
                ...
                {
                    craftingSystem.RemoveUsedIgridient();
        ...
        // Check for crafting recipes if the target or source inventory is a crafting type
        if (targetInventory != null && targetInventory.inventoryType == InventoryType.Crafting)
        {
            craftingSystem.CheckForRecipe();
        }
        if (sourceInventory != null && sourceInventory.inventoryType == InventoryType.Crafting)
        {
            craftingSystem.CheckForRecipe();
        }
    }
